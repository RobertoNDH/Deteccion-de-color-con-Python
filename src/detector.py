...
class ColorDetector:
    ...
    def __init__(self, color_configs: dict, min_contour_area: int = 500, blur_kernel_size: int = 5):
    ...
    def get_combined_mask(self, hsv: np.ndarray, color_name: str) -> Optional[np.ndarray]:
